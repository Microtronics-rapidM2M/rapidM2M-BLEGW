 ...
 * The continuous scan for BLE devices is activated by closing the reed switch. By closing the reed switch again the scan
 * is deactivated. 
 *
...
forward public KeyPressed(iKeyState);       // Called up when the reed switch is closed or opened
...
/**
 * Function that should be called up when the reed switch is closed or opened
 *
